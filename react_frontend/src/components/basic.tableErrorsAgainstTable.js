...
function Table({ clickOnRowFunc, columns, data, onChangeFunc, onChangeTextboxFunc, submitButtonEvent }) {
...
function ErrorTableComponent({ data, onChangeFunc, onChangeTextboxFunc, submitButtonEvent, clickOnRowFunc }) {
	...
	const columns = React.useMemo(
        () => [
            {
                Header: 'Click on a row to see corresponding play',
                columns: [
                    {
                        Header: 'GameDetails',
                    ...
                    },
					{
                        ...
                        accessor: 'review_decision',
                    },
                    {
                        Header: 'Commiting',
                        accessor: 'committing_player',
                    },
                    {
                        Header: 'Disadvantaged',
                        accessor: 'disadvantaged_player',
                    },
					{
                        Header: 'video_link',
                        accessor: 'video_link',
    ...
    return (
<Table clickOnRowFunc={clickOnRowFunc} columns={columns} data={data} onChangeTextboxFunc={onChangeTextboxFunc} onChangeFunc={onChangeFunc} submitButtonEvent={submitButtonEvent}/>
    )
}
